...
<img width="1919" height="645" alt="image" src="https://github.com/user-attachments/assets/40f5af8d-505f-4200-ae88-6b6a5b61706a" />
...
## cool features
Recently updated repos and time tracking are both live-updating! Also, links in their own cells are highlighted with a css "link" class, but the links which are in cells also including non-link text are detected using Javascript and assigned link tags which span from the start to the end of the URL, leaving the rest of the cell un-linked. The logo is custom-drawn by me! The text says CW.dev, since my domain is charlottewoodrum.dev. 
